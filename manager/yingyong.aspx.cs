...
public partial class manager_yingyong : System.Web.UI.Page
{
    ...
    protected void Submit1_ServerClick(object sender, EventArgs e)
    {
        ...
        if (bpic.Length > 1)
        {
            ...
            {
                sql = "insert into Links(title,Picture,linkpic,CreateDate,languageId,linkurl,paird) values('" + name.Text + "','" + bpic + "','" + spic + "','" + DateTime.Now.ToString() + "','" + rbl.SelectedValue + "','" + web.Text + "',15)";
        ...
        else
        {
            ...
            {
                sql = "insert into Links(title,Picture,linkpic,CreateDate,languageId,linkurl,paird) values('" + name.Text + "','nopic.gif ','nopic.gif ','" + DateTime.Now.ToString() + "','" + rbl.SelectedValue + "','" + web.Text + "',15)";
