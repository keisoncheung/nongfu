<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vediosshow.aspx.cs" Inherits="manager_vediosshow" %>
    ...
    <%--<fieldset  style="width:758px; font-size:12px;">
        ...
        <asp:GridView ID="grv1" runat="server" AutoGenerateColumns="False" CellPadding="4" OnPageIndexChanging="grv1_PageIndexChanging"
            ...
            <Columns>
                ...
                <asp:HyperLinkField HeaderText="编辑" Text="【查看】"  DataNavigateUrlFields="id" DataNavigateUrlFormatString="vediosshow.aspx?id={0}&amp;ac=产品应用">
